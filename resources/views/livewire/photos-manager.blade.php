<div>
    ...
    <!-- Upload Section -->
    <div class="py-6 mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">{{ __('front.profiles.photos.upload') }}</h2>
        ...
        <form wire:submit="uploadImages" class="space-y-4">
            ...
            @if(!empty($images))
            <div>
                <h2 class="text-lg font-medium text-gray-700 mb-2">{{ __('front.profiles.photos.preview') }}</h2>
            ...
            <div class="flex justify-end">
                <button
                    ...
                    <span wire:loading.remove>{{ __('front.profiles.photos.upload_button') }}</span>
                    <span wire:loading>{{ __('front.profiles.photos.uploading') }}</span>
                </button>
            </div>
            @endif
    ...
    <div class="py-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">{{ __('front.profiles.photos.myphotos') }} ({{ $existingImages->count() }})</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="relative group">
                <img 
                    src="{{ $image->getUrl() }}" 
                    alt="Profile image" 
                    class="w-full aspect-[4/5] object-cover rounded-lg border border-gray-200 cursor-pointer hover:shadow-lg transition-shadow"
    ...
    <div class="card p-6">
        <div class="text-center py-8">
            ...
            <p class="text-sm text-gray-500">{{ __('front.profiles.photos.nophotos_desc') }}</p>
        </div>
    </div>
    @endif
